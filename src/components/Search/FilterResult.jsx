...
const FilterResult = ({ data, name }) => {
  return (
    <div>
      ...
      <div className="flex items-center gap-4 flex-wrap overflow-scroll  py-2 md:overflow-x-scroll  ">
...
const ArtistList = ({ artist }) => {
  ...
  return (
    <div
      className="md:max-w-[523px] w-44  h-48 md:w-96 md:h-[350px] md:my-2  overflow-hidden rounded-3xl relative md:mt-7 mt-4 "
    ...
    >
      ...
      <div className="absolute -bottom-1 md:h-[93px] bg-[#151515] w-full  ">
        <p className="m-auto md:text-2xl text-xl p-2 md:p-6 whitespace-nowrap">
          {artist?.name}
        </p>
      </div>
    </div>
